  ...
  return (
    <div className="space-y-6 font-sans" id="dashboard-container">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4" id="stat-cards-panel">
        ...
        <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-sm flex flex-col justify-between hover:border-slate-300 transition-colors">
          <p className="text-xs font-extrabold text-emerald-650 uppercase tracking-widest mb-1">Đang hoạt động</p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-3">
          ...
          <div className="relative col-span-1 sm:col-span-2 md:col-span-3 lg:col-span-1">
            ...
            <input
              ...
              className="w-full pl-9 pr-3 py-2 border border-slate-200 rounded-lg text-sm bg-slate-50/50 hover:bg-white focus:outline-none focus:ring-2 focus:ring-emerald-550 focus:border-emerald-550 transition-all"
              id="search-input"
            />
          </div>
          ...
          <div>
            <select
              ...
              className="w-full text-slate-700 font-medium py-2 px-3 border border-slate-200 rounded-lg text-sm bg-white focus:outline-none focus:ring-2 focus:ring-emerald-550 focus:border-emerald-550"
              id="filter-status"
            >
          ...
          <div>
            <select
              ...
              className="w-full text-slate-700 font-medium py-2 px-3 border border-slate-200 rounded-lg text-sm bg-white focus:outline-none focus:ring-2 focus:ring-emerald-550"
              id="filter-level"
            >
